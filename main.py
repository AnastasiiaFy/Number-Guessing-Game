"""
Консольна гра, у якій компʼютер випадково обирає число, а користувач має його відгадати за обмежену кількість спроб.

Вимоги:
-/ після запуску привітальне повідомлення з правилами гри
-/ вибір режиму гри, який вирішуватиме кількість спроб
-/ ввід користувачем здогадки
-/ якщо здогадка правильна, то вивести привітальне повідомлення з кількістю використаних спроб
-/ якщо вона не правильна, вивести повідомлення чи загадане число більше, чи менше за здогадку
-/ гра завершується коли число відгадане або спроби закінчилися

Додаткові опції
-/ можливість продовжити гру
- з кожним наступним рівнем збільшувати діапазон
-/ рейтинг по складностях
